...
- **Inputs**: short description of the project.
- **Steps**: ask clarifying questions → brainstorm approaches → pick the best approach → build timeline and tasks → **start executing the tasks**.
- **Output**: planned project + work already underway. She credits this playbook with 3× project throughput.
